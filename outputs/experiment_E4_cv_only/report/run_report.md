...
- Assembled records: `80`
- Final records evaluated: `80`
- Actually verified: `4`
- Final unresolved: `48`
- Final rejected: `28`
...
## Scope Buckets
- out_of_scope: 16
- recoverable_unresolved: 45
- strict_in_scope: 4
- useful_but_out_of_scope: 15

## Scope Tags
- non_target_api: 16
- recoverable_api_basis: 27
- recoverable_area: 6
...
- digitized_endpoints_ok: 34
- mapped_curves: 10
- triage_artifacts: 22
- triage_digitize_candidates: 20
- triage_has_permeation_plot_true: 20
- unmapped_curves: 24
...
- why_not_digitizable:the_figure_does_not_contain_any_endpoint_curves_related_to_ibuprofen: 1
...
- review_focus:api_concentration_basis: 27
