# E8 Relaxed Scope Delta vs full_run_13 V1 baseline
...
| Metric | full_run_13 V1 baseline | E8 relaxed scope | Delta |
|---|---:|---:|---:|
| final records | 79 | 74 | -5 |
| verified | 4 | 14 | +10 |
| unresolved | 48 | 37 | -11 |
| rejected | 27 | 23 | -4 |
...
| Route | full_run_13 V1 baseline | E8 | Delta |
|---|---:|---:|---:|
| table | 0 | 3 | +3 |
| text | 0 | 0 | +0 |
| mixed | 0 | 1 | +1 |
...
- New verified by record_id: `12` from `5` papers.
- Lost verified from full_run_13 V1 baseline: `2`.
- Concentration distribution among new verified: `{'0.1/0.9 to 0.9/0.1': 1, '5 % w/w w/w': 4, '1 % w/w w/w': 4, 'n/a': 3}`
...
| record_8b7dd5d8bd7f | 10.1016/j.ijpharm.2016.03.043 | figure | IBUGEL™ | Ibuprofen | 5 % w/w w/w | 40 µg/cm² |
...
|---|---:|---:|---:|
| ambiguous_api_concentration | 42 | 0 | -42 |
| missing_endpoint | 11 | 4 | -7 |
| figure_digitization_failed | 8 | 2 | -6 |
| not_target_study_type | 12 | 7 | -5 |
| not_target_api | 16 | 14 | -2 |
...
|---|---:|---:|---:|
| total tokens | 3838632 | 3640967 | -197665 |
| elapsed seconds | 5003.045 | 5569.776 | +566.731 |
