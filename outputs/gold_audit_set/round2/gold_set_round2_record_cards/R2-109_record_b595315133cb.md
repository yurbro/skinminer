...
- Label: Ibuprofen - 200 um microneedle
- API: ibuprofen
- Concentration:   ()
...
- Membrane: bovine split skin, pretreated with 200 um microneedle roller (bovine udder (Holstein Friesian), 600.0 um)
