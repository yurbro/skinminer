...
- Results file: `outputs\experiment_single_pass_pdf_4omini\single_pass_results.jsonl`
- Model: `gpt-4o-mini`
...
- Single-pass records emitted: `106`
- Actual usage from completed LLM calls: input `5,444,611`, output `34,646`, total `5,479,257` tokens.

## 3. Gold True Positive Coverage
- Gold keep-record rows: `25`
- Covered by single-pass match on DOI + formulation label + endpoint time: `9/25 = 36.0%`
...
- Covered value-anchored rows: `9/24 = 37.5%`
- Value-correct among all value-anchored gold rows: `9/24 = 37.5%`
- Value-correct among covered value-anchored rows: `9/9 = 100.0%`

## 4. Annotated False Positive Interaction
- Annotated `gold_keep_record=no` rows matched by single-pass: `3/105`
- Single-pass extra records not matched to any Round2 annotation row: `94`
...
- Matched gold TP records: `9`
- Membrane field non-empty: `9/9 = 100.0%`
- Receptor medium non-empty: `9/9 = 100.0%`
- Dose field non-empty: `9/9 = 100.0%`
- Excipient composition non-empty: `9/9 = 100.0%`
